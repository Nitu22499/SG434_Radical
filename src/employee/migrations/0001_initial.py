    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_social_category', models.CharField(blank=True, choices=[('OPEN', 'OPEN'), ('SC', 'SC'), ('ST', 'ST'), ('OBC', 'OBC'), ('ORC', 'ORC'), ('OTHERS', 'OTHERS')], max_length=30, verbose_name='Social Category')),
                ...
                ('employee_disability', models.CharField(blank=True, choices=[('Not Applicable', 'Not Applicable'), ('Loco motor', 'Loco motor'), ('Visuals', 'Visuals'), ('Other', 'Other'), ('Hearing Impaired', 'Hearing Impaired')], max_length=256, verbose_name='Disability')),
                ...
                ('employee_contact_number', models.IntegerField(blank=True, validators=[employee.validators.validate_phone_number], verbose_name='Contact Number')),
                ...
                ('employee_school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.School')),
