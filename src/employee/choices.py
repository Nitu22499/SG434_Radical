...
ACADEMIC_QUALIFICATION = (
    ('Below Secondary', 'Below Secondary'), ('Secondary', 'Secondary'), ('High Secondary', 'High Secondary'),
    ('Graduate', 'Graduate'), ('Post-Graduate', 'Post Graduate'), ('M Phil', 'M Phil'), ('Ph.D', 'Ph.D'),
...
TEACHER_TYPE = (
    ('Head Teacher', 'Head Teacher'), ('Acting Head Teacher', 'Acting Head Teacher'), ('Teacher', 'Teacher'),
    ('Instruction Positioned Teacher', 'Instruction Positioned Teacher'), ('Principal', 'Principal'),
    ('Vice-Principal', 'Vice-Principal'), ('Lecturer', 'Lecturer')
)
TRAINING_OPTIONS = (
